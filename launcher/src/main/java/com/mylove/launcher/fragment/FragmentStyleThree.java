...
public class FragmentStyleThree extends BaseFragment implements IMainStatus {
    ...
    public void bindView(View view, Bundle savedInstanceState) {
        ...
        tvRecyclerView.setSpacingWithMargins(4, 8);
        mAdapter = new SpannableGridAdapter<LchItemBean>(getActivity(),tvRecyclerView,R.layout.launcher_three_item){
            @Override
        ...
        mAdapter.setDatas(BeanUtils.getThree(3,"three"));
